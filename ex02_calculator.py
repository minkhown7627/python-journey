...
gia_cafe = 35000
so_ly = 3
tien_con_lai = tien_ban_dau - (so_ly * gia_cafe)
...
tong_keo = 100
so_nguoi = 7
moi_nguoi = tong_keo // so_nguoi  # Phép chia lấy phần nguyên
du = tong_keo % so_nguoi          # Phép chia lấy phần dư
print("Mỗi người được:", moi_nguoi, "viên kẹo")
print("Còn dư:", du, "viên kẹo")
